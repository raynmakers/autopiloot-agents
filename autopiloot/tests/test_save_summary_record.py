"""
Test suite for SaveSummaryRecord tool.
Tests Firestore integration, reference linking, and status management.
"""
...
class TestSaveSummaryRecord(unittest.TestCase):
    """Test cases for SaveSummaryRecord tool."""
    ...
    def setUp(self):
        ...
        self.tool = SaveSummaryRecord(
            video_id="test_video_123",
            refs=self.test_refs
        )

    @patch('summarizer_agent.tools.SaveSummaryRecord.firestore.Client')
    def test_successful_summary_record_creation(self, mock_firestore):
        """Test successful summary record creation and video status update."""
        ...
        self.assertEqual(video_update["summary_short_drive_id"], "1BvGjZqX5YK8H3mP9QnRtS7Ua2VwE4")
        self.assertEqual(video_update["zep_doc_id"], "summary_test_video_123")

    @patch('summarizer_agent.tools.SaveSummaryRecord.firestore.Client')
    def test_missing_transcript_doc_ref(self, mock_firestore):
        """Test handling when transcript_doc_ref is missing from refs."""
    ...
    def test_refs_validation(self):
        """Test validation of refs parameter structure."""
        # Test with minimal required refs
        minimal_refs = {
            "transcript_doc_ref": "transcripts/test_video_123"
        }
